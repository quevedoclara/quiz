...
instanteCreacion = (new Date(). getMinutes() * 60) + new Date(). getSeconds() ;
req.session.user = {id:user.id, username:user.username, tiempo: instanteCreacion + 120, isAdmin:user.isAdmin };
...
if( ((new Date(). getMinutes() * 60) + new Date(). getSeconds() )>= req.session.user.tiempo ) {
